...
<head>
    ...
    <title>intro</title>
    <link rel="stylesheet" href="intro/css/all.min.css">
    <link rel="stylesheet" href="intro/css/header.css">
    <link rel="stylesheet" href="intro/css/owl.carousel.min.css">
        ...
        <div class="container">
            <nav id="navigation1" class="navigation">
                <a class="nav-brand" href="javascript:">
                    <img src="intro/images/logo.png" alt="logo-img">
                </a>
                <div class="parent-nav-menu">
                    ...
                    <div class="parent-btn-header">
                        ...
                        <!--                            ورود/ ثبت نام-->
                        <!--                        </a>-->
                        <a href="javascript:" class="btn btn-register">
                            0912123456
                        </a>
                    </div>
        ...
        <div class="owl-img-banner">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 p-0">
                <div class="owl-banner owl-carousel owl-theme">
                    <div class="item">
                        <img src="intro/images/IMG_5845.JPG" alt="img-banner">
                    </div>
                    <div class="item">
                        <img src="intro/images/IMG_7607.JPG" alt="img-banner">
                    </div>
                    <div class="item">
                        <img src="intro/images/IMG_584500.jpg" alt="img-banner">
                    </div>
                    <div class="item">
                        <img src="intro/images/IMG_804622.jpg" alt="img-banner">
                    </div>
                    <div class="item">
                        <img src="intro/images/IMG_4019.JPG" alt="img-banner">
                    </div>
                    <div class="item">
                        <img src="intro/images/IMG_806288.jpg" alt="img-banner">
                    </div>
                    <div class="item">
                        <img src="intro/images/IMG_8060111.jpg" alt="img-banner">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="">
                            <div class="d-flex justify-content-center py-7 py-lg-15 px-5 px-md-15 w-100">
                                <a href="/" class="link-img-banner">
                                    <img alt="Logo" src="intro/images/logo.png" class="w-75"/>
                                </a>
                            </div>
            ...
            <div class="parent-app row d-flex flex-wrap align-items-center">
                <div class="app-text col-lg-6 col-md-6-12 col-sm-12 col-12 text-right">
                    ...
                    <div class="parent-btn-app">
                        <a href="" class="">
                            <img src="intro/images/download-apk.png" alt="app">
                        </a>
                        <a href="" class="">
                            <img src="intro/images/install-pwa.png" alt="app">
                        </a>
                    </div>
                    <img src="intro/images/appImg-ris2.png" alt="app-img">
                    <div class="parent-btn-app-ris">
                        ...
                        <!--                        </a>-->
                        <a href="" class="">
                            <img width="100%" src="intro/images/download-apk.png" alt="app">
                        </a>
                        <a href="" class="">
                            <img width="100%" src="intro/images/install-pwa.png" alt="app">
                        </a>
                    </div>
                </div>
                <div class="app-img col-lg-6 col-md-6-12 col-sm-12 col-12 ">
                    <img src="intro/images/appImg2.png" alt="app-img">
                </div>
            </div>
        </div>
    </section>
...
<script src="intro/js/jquery-3.4.1.min.js"></script>
<script src="intro/js/bootstrap.min.js"></script>
<script src="intro/js/header.js"></script>
<script src="intro/js/owl.carousel.min.js"></script>
<script src="intro/js/script.js"></script>
</html>
