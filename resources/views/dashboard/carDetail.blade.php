                                ...
                                <div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-3" data-kt-menu="true" style="">
                                        <div class="menu-item px-3">
                                            <a onclick="changeProject('1','14');" class="menu-link px-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="pt-0">
                                                    <div class="pb-5 fs-6">
                                                        <div class="fw-bold mt-2">نوع</div>
                                                        <div class="text-gray-600">{{$car_type[$car['cat_id']]['name']}}</div>
                                                        <div class="fw-bold mt-2">سیستم</div>
                                                        <div class="text-gray-600">{{$car_type[$car['subcat_id']]['name']}}</div>
                                                        <div class="fw-bold mt-2">مدل</div>
                                                        <div class="text-gray-600">{{$carInfo['model']}}</div>
                                                        <div class="fw-bold mt-2">تعداد سیلندر</div>
                                                        <div class="text-gray-600">{{$carInfo['cylinderCount']}}</div>
                                                        <div class="fw-bold mt-2">شماره VIN</div>
                                                        <div class="text-gray-600" style="font-family: Tahoma !important;letter-spacing: 5px !important;">{{$carInfo['vin']}}</div>
                                                        <div class="fw-bold mt-2">شناسه موتور</div>
                                                        <div class="text-gray-600" style="font-family: Tahoma !important;letter-spacing: 5px !important;">{{$carInfo['engineNumber']}}</div>
                                                        <div class="fw-bold mt-2">شماره شاسی</div>
                                                        <div class="text-gray-600" style="font-family: Tahoma !important;letter-spacing: 5px !important;">{{$carInfo['chassisNumber']}}</div>
                                                        <div class="fw-bold mt-2">شماره بدنه</div>
                                                        <div class="text-gray-600" style="font-family: Tahoma !important;letter-spacing: 5px !important;">{{$carInfo['bodyNumber']}}</div>
                                                        <div class="fw-bold mt-2">شماره ملی</div>
                                                        <div class="text-gray-600">{{$carInfo['nationalId']}}</div>
                                                        <div class="fw-bold mt-2">شرکت مالک</div>
                                                        <div class="text-gray-600">@if(isset($company[$driver['company_id']])){{$company[$driver['company_id']]['name']}}@endif </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card mb-5 mb-xl-8">
                                            <div class="card-body">
                                                ...
                                                <div class="pb-5 fs-6">
                                                    ...
                                                    <div class="fw-bold mt-2">مدرک تحصیلی</div>
                                                    <div class="text-gray-600">{{$driver_info['education']}}</div>
                                                    <div class="fw-bold mt-2">وضعیت خدمت سربازی</div>
                                                    <div class="text-gray-600">{{$driver_info['militaryType']}}</div>
                                                    <div class="fw-bold mt-2">آدرس</div>
                                                    <div class="text-gray-600">{{$driver_info['address']}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
